#!/usr/bin/env python
"""v0_bash_agent.py - 极简 Claude Code | Bash is All You Need"""
from anthropic import Anthropic
import subprocess, sys, os

client = Anthropic(api_key="sk-abx", base_url="https://api.moonshot.cn/anthropic")
...
if __name__ == "__main__":
    if len(sys.argv) > 1: print(chat(sys.argv[1]))
    else:
        h = []
        while (q := input("\033[36m>> \033[0m")) not in ("q", "exit", ""): print(chat(q, h))